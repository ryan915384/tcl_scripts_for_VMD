...
# proc auto_mass-density-resname { out_file_name } {
	...
	# foreach resname_inlist $resname_list {
		...
		# }
# }
#auto_mass-density-resname 7F1C2O-8F1S3O		
2015-mass-density -100 100 SOL "resname SOL" 60 60 2 150 200 1
2015-mass-density -100 100 GE01 "resname GE01" 60 60 2 150 200 1
