...
proc 2015_scd-1-3 {atomsel_list C1 C2 C3 C4 frame_0 frame_1 output_name } {
	set outfile [open scd-$output_name.dat w]
	puts $outfile "
$C3	[Scd_selection_CAH01_frame01_loop $atomsel_list $C4 $C3 $frame_0 $frame_1]
$C2	[Scd_selection_CAH01_frame01_loop $atomsel_list $C4 $C2 $frame_0 $frame_1]
$C1	[Scd_selection_CAH01_frame01_loop $atomsel_list $C4 $C1 $frame_0 $frame_1]
	"
		#[Scd_selection_CAH01_frame01_loop $atomsel_list $CAH_0 $C8 $frame_0 $frame_1]
	close $outfile
}

proc 2015_scd-1-12 {atomsel_list C1 C2 C3 C4 C5 C6 C7 C8 C9 C10 C11 C12 C13 frame_0 frame_1 output_name } {
	set outfile [open scd-$output_name.dat w]
	puts $outfile "
$C12 [Scd_selection_CAH01_frame01_loop $atomsel_list $C13 $C12 $frame_0 $frame_1]
$C11 [Scd_selection_CAH01_frame01_loop $atomsel_list $C13 $C11 $frame_0 $frame_1]
$C10 [Scd_selection_CAH01_frame01_loop $atomsel_list $C13 $C10 $frame_0 $frame_1]
$C9 [Scd_selection_CAH01_frame01_loop $atomsel_list $C13 $C9 $frame_0 $frame_1]
$C8 [Scd_selection_CAH01_frame01_loop $atomsel_list $C13 $C8 $frame_0 $frame_1]
$C7 [Scd_selection_CAH01_frame01_loop $atomsel_list $C13 $C7 $frame_0 $frame_1]
$C6	[Scd_selection_CAH01_frame01_loop $atomsel_list $C13 $C6 $frame_0 $frame_1]
$C5	[Scd_selection_CAH01_frame01_loop $atomsel_list $C13 $C5 $frame_0 $frame_1]
$C4	[Scd_selection_CAH01_frame01_loop $atomsel_list $C13 $C4 $frame_0 $frame_1]
$C3	[Scd_selection_CAH01_frame01_loop $atomsel_list $C13 $C3 $frame_0 $frame_1]
$C2	[Scd_selection_CAH01_frame01_loop $atomsel_list $C13 $C2 $frame_0 $frame_1]
$C1	[Scd_selection_CAH01_frame01_loop $atomsel_list $C13 $C1 $frame_0 $frame_1]
	"
		#[Scd_selection_CAH01_frame01_loop $atomsel_list $CAH_0 $C8 $frame_0 $frame_1]
	close $outfile
}

proc 2015_scd-1-8 {atomsel_list C1 C2 C3 C4 C5 C6 C7 C8 CAH_0 frame_0 frame_1 output_name } {
	set outfile [open scd-$output_name.dat w]
	puts $outfile "
		$C8 [Scd_selection_CAH01_frame01_loop $atomsel_list $CAH_0 $C8 $frame_0 $frame_1]
		$C7 [Scd_selection_CAH01_frame01_loop $atomsel_list $CAH_0 $C7 $frame_0 $frame_1]
		$C6 [Scd_selection_CAH01_frame01_loop $atomsel_list $CAH_0 $C6 $frame_0 $frame_1]
		$C5 [Scd_selection_CAH01_frame01_loop $atomsel_list $CAH_0 $C5 $frame_0 $frame_1]
		$C4 [Scd_selection_CAH01_frame01_loop $atomsel_list $CAH_0 $C4 $frame_0 $frame_1]
